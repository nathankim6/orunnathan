...
function systemPrompt(schoolType: 'middle' | 'high', examScope?: string, originalPassages?: string) {
  ...
  return [
    ...
    '- markupDependent: 밑줄이나 네모 상자가 있어야 문제가 성립하면 true. 예: 밑줄 친 (a)~(e) 중 어법상 틀린 것, 네모 안에서 알맞은 말 고르기, 밑줄 친 부분이 가리키는 것. 밑줄·네모 없이 글만으로 성립하는 문항(빈칸 추론, 주제/제목, 순서 배열, 요약 등)은 false',

...
Hs("R1   True / False   ·   1 F · 2 F · 3 T · 4 T · 5 F · 6 F · 7 T · 8 T");
   B("1 F — 문장 4: 태평양이 아니라 카리브해(Caribbean Sea)다.   2 F — 문장 12: 자동차가 아니라 새 보트(boat)를 주었다.   3 T — 문장 11.   4 T — 문장 1–2.   5 F — 문장 6: 경찰이 아니라 해군(navy)을 불렀다.   6 F — 문장 8: 우유가 아니라 케첩(ketchup) 한 병이다.   7 T — 문장 7.   8 T — 문장 5.  거짓 문장은 모두 한 단어만 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (d) → (c) → (a) → (b)");

...
Hs("R1   True / False   ·   1 T · 2 T · 3 F · 4 F · 5 F · 6 F · 7 T · 8 T");
   B("1 T — 문장 1.   2 T — 문장 10.   3 F — 문장 2: 결코 앉지 않는 게 아니라 가끔 피부에 앉는다.   4 F — 문장 7: 설탕이 아니라 소금(salt)을 얻는다.   5 F — 문장 9: 잠자기 위해서가 아니라 번식(reproduction)을 위해서다.   6 F — 문장 6: 그냥 쉬는 것이 아니다.  거짓 문장은 모두 한 요소만 비튼 것이다.   7 T — 문장 8.   8 T — 문장 4.", true);
Hs("R2   사건 순서   ·   (c) → (d) → (a) → (b)");

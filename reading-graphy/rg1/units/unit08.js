...
K.push(sp(65));
["① From Hunter to Helper: Johnny’s New Job",
...
["① 필리핀 어부들의 낚시 여행",
 "② 바다거북 알로 만드는 요리",
 "③ 바다거북 알을 지키는 새 직업을 찾은 사람"].forEach(c =>
...
Hs("R1   True / False   ·   1 F · 2 T · 3 T · 4 T · 5 F · 6 F · 7 T · 8 F");
   B("1 F — 문장 15: 쉽지 않다고 했다.   2 T — 문장 10.   3 T — 문장 3.   4 T — 문장 8.   5 F — 문장 9: WWF가 아니라 CURMA다.   6 F — 문장 11: 강(river)이 아니라 바다(ocean)로 돌려보냈다.   7 T — 문장 12.   8 F — 문장 5: 더 이상 하지 않는다.  거짓 문장은 모두 한 요소(still, WWF, river, easy)만 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (d) → (b) → (a) → (c)");

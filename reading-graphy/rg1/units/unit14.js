...
Hs("R1   True / False   ·   1 T · 2 T · 3 F · 4 F · 5 F · 6 F · 7 T · 8 T");
   B("1 T — 문장 1.   2 T — 문장 3–4.   3 F — 문장 5: 자유롭게 움직인 게 아니라 아주 가만히 앉아 있어야 했다.   4 F — 문장 2: 결혼식 같은 즐거운 자리에서도 웃지 않았다.   5 F — 문장 13: 전통은 천천히 바뀌기 시작했다.  거짓 문장은 모두 한 요소(smiled a lot, freely, was, never)만 비튼 것이다.   6 F — 문장 9: 적절하다가 아니라 적절하지 않다고 믿었다.   7 T — 문장 7.   8 T — 문장 11.", true);
Hs("R2   사건 순서   ·   (c) → (a) → (b) → (d)");

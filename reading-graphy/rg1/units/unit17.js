...
["① James Cook likes doing things in a traditional way.",
 ...
 "④ He believes that some technologies never die.",
 "⑤ One picture takes him only a few minutes."].forEach(c => K.push(ch(c)));
K.push(spF(1, 140, 0.13));
...
K.push(T(tfw, [
  ...
  ...[
    ...
    "He uses an old machine called a typewriter.",
    "His goal is to show us that old machines are useless."].map((s, i) => new TableRow({ children: [

...
Hs("R1   True / False   ·   1 T · 2 T · 3 F · 4 F · 5 F · 6 F · 7 T · 8 T");
   B("1 T — 문장 5.   2 T — 문장 3.   3 F — 문장 10: 약한 게 아니라 강력한(powerful) 자외선 차단제다.   4 F — 문장 6: 밝은 달이 아니라 밝은 해(sun)다.   5 F — 문장 3: 여자만이 아니라 남자와 여자 둘 다(Both men and women)다.   6 F — 문장 12: 세균을 강하게 하는 게 아니라 물리치도록(fight) 돕는다.  거짓 문장은 모두 본문에서 딱 한 요소(only women, moon, weak, stronger)를 비튼 것이다.   7 T — 문장 1.   8 T — 문장 9.", true);
Hs("R2   사건 순서   ·   (b) → (c) → (a) → (d)");

...
Hs("R1   True / False   ·   1 F · 2 T · 3 T · 4 F · 5 F · 6 T · 7 F · 8 T");
   B("1 F — 문장 11: 더 비싸서가 아니라 덜 비싸서(less expensive) 쓰기 시작했다.   2 T — 문장 9.   3 T — 문장 1.   4 F — 문장 7: WOOD가 아니라 LEGO로 이름을 바꿨다.   5 F — 문장 2: 1924년이 아니라 1916년에 가게를 열었다.   6 T — 문장 6.   7 F — 문장 13: 1916년이 아니라 1949년에 첫 플라스틱 장난감을 만들었다.   8 T — 문장 3.  거짓 문장은 모두 본문에서 딱 한 요소(1924, WOOD, more, 1916)를 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (b) → (a) → (d) → (c)");

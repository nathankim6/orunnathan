...
Hs("R1   True / False   ·   1 F · 2 T · 3 F · 4 F · 5 T · 6 F · 7 T · 8 T");
   B("1 F — 문장 2: 열두 시간이 아니라 약 두 시간이다.   2 T — 문장 10–11.   3 F — 문장 12: 더 자는 게 아니라 먹이를 찾으러 수면으로 올라간다.  거짓 문장은 모두 딱 한 요소(twelve, longer, deep on the floor, sleep more)를 비튼 것이다.   4 F — 문장 8: 바닥 깊은 곳이 아니라 수면 가까이(near the surface) 머문다.   5 T — 문장 7.   6 F — 문장 6: 20분보다 길지 않고 짧다(less than).   7 T — 문장 3.   8 T — 문장 1.", true);
Hs("R2   사건 순서   ·   (b) → (d) → (a) → (c)");

...
["① in a toothpaste factory",
 ...
 "④ in a new product shop",
 "⑤ at the Museum of Failure"].forEach(c => K.push(ch(c)));
K.push(spF(1, 140, 0.13));
...
B("문장 1 try to forget them fast   ① ○ 머릿속에서 얼른 지우려 애쓴다.   ② ✕ [반대] 오래 기억하고 싶어 한다 — 정반대.   ③ ✕ [무관] 싸게 판다는 말은 지문에 없다.");
B("문장 5 some funny examples   ① ✕ [반대] 아주 심각하고 슬픈 것들 — 정반대.   ② ○ 좀 이상하고 웃긴 것들.   ③ ✕ [무관] 값이 비싸다는 말은 지문에 없다.");
B("문장 9 they learned and improved   ① ✕ [무관] 아무것도 만들지 않게 됐다는 말은 지문에 없다.   ② ✕ [반대] 같은 실수를 되풀이했다 — 정반대.   ③ ○ 전보다 나아졌다.");
B("문장 12 a way to become better   ① ○ 자라게 도와주는 길이다.   ② ✕ [반대] 절대 가면 안 되는 길 — 정반대.   ③ ✕ [무관] 학교 과목이라는 말은 지문에 없다.");
...
Hs("R1   True / False   ·   1 T · 2 F · 3 T · 4 F · 5 F · 6 T · 7 F · 8 T");
   B("1 T — 문장 1.   2 F — 문장 8: 큰 회사들도 실수를 했다.   3 T — 문장 7.   4 F — 문장 6: 여자가 아니라 남자(A man)다.   5 F — 문장 3: 노르웨이(Norway)가 아니라 스웨덴(Sweden)이다.   6 T — 문장 5.   7 F — 문장 11: 방문객은 자기 실수를 적을 수 있다.   8 T — 문장 4.  거짓 문장은 모두 딱 한 요소(Norway, woman, never, must not)를 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (d) → (b) → (a) → (c)");

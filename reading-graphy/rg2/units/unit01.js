...
pairGrid(
  { sn: 9, main: "tried to stop them, but couldn\u2019t",
    opts: ["① easily made them stop", "② wanted to feed them", "③ failed to stop them"] },
...
K.push(sp(130));
[["문장 3", [t("While he ", { size: 19 }), t("( walking  /  was walking )", { size: 19, bold: true, color: NAVY }), t(", he saw about 20 furry animals.", { size: 19 })], "진행형은 be+~ing — 한 덩어리의 동사예요."],
...
B("문장 9 tried to stop them, but couldn\u2019t   ① ✕ [반대] 쉽게 멈추게 했다 — 정반대.   ② ✕ [무관] 먹이를 주고 싶었다는 말은 지문에 없다.   ③ ○ failed to stop them = 멈추게 하지 못했다.");
...
Hs("R1   True / False   ·   1 T · 2 T · 3 F · 4 T · 5 F · 6 F · 7 T · 8 F");
   B("1 T — 문장 3.   2 T — 문장 10.   3 F — 문장 11: 진정한 뒤 물로 돌아갔다.   4 T — 문장 1.   5 F — 문장 9: 멈추려 했지만 그럴 수 없었다.   6 F — 문장 6: 일부러(on purpose)가 아니라 실수로(accidentally) 밟았다.   7 T — 문장 8.   8 F — 문장 2: 밝은 게 아니라 아직 어둡고 조용했다.  거짓 문장은 모두 본문에서 딱 한 단어(bright, on purpose, easily, never)를 비튼 것이다 — 그 한 단어를 찾는 것이 정독이다.", true);
Hs("R2   사건 순서   ·   (d) → (b) → (c) → (a)");

...
B("문장 5 got close   ① ✕ [반대] 멀리 달아났다 — 정반대.   ② ○ moved near = 가까이 다가갔다.   ③ ✕ [무관] 사진을 찍었다는 말은 지문에 없다.");
B("문장 9 tried to stop them, but couldn\u2019t   ① ○ failed to stop them = 멈추게 하지 못했다.   ② ✕ [반대] 쉽게 멈추게 했다 — 정반대.   ③ ✕ [무관] 먹이를 주고 싶었다는 말은 지문에 없다.");
B("문장 12 be careful around wild animals   ① ✕ [반대] 자유롭게 논다 — 정반대.   ② ✕ [무관] 반려동물로 기른다는 말은 지문에 없다.   ③ ○ watch out near wild animals = 야생 동물 근처에서 조심하다.");

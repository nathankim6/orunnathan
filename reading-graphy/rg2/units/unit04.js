...
["① 물건을 팔기 위해 만든 광고",
 ...
 "③ 친구에게 안부를 전하는 편지",
 "④ 자신의 의견을 내세우는 주장 글",
 "⑤ 한 발명의 이야기를 들려주는 설명문"].forEach(c => K.push(p([t(c, { size: 19 })], { after: 55, indent: { left: 440, hanging: 190 }, line: 268 })));
...
pairGrid(
  { sn: 3, main: "take apart shoes",
    opts: ["① put shoes together", "② buy many new shoes", "③ separate shoes into pieces"] },
...
pairGrid(
  ...
  { sn: 11, main: "kept trying and finally succeeded",
    opts: ["① gave up in the end", "② took a long rest", "③ did not stop and made it"] });
...
K.push(sp(130));
[["문장 1", [t("Bill Bowerman ", { size: 19 }), t("( were  /  was )", { size: 19, bold: true, color: NAVY }), t(" a running coach at a college.", { size: 19 })], "주어가 한 명(단수)일 때, 과거의 be동사는?"],
...
B("문장 3 take apart shoes   ① ✕ [반대] 신발을 조립하다 — 정반대.   ② ✕ [무관] 새 신발을 많이 산다는 말은 지문에 없다.   ③ ○ 신발을 조각조각 분리하다.");
B("문장 5 wasn’t a fast runner   ① ✕ [반대] 매우 빨리 달렸다 — 정반대.   ② ○ did not run fast = 빨리 달리지 못했다.   ③ ✕ [무관] 아침 식사를 싫어했다는 말은 지문에 없다.");
B("문장 7 noticed his wife’s waffle iron   ① ✕ [반대] 전혀 보지 못했다 — 정반대.   ② ○ saw the waffle iron = 와플 틀을 보았다.   ③ ✕ [무관] 와플을 많이 구웠다는 말은 지문에 없다.");
B("문장 11 kept trying and finally succeeded   ① ✕ [반대] 결국 포기했다 — 정반대.   ② ✕ [무관] 오래 쉬었다는 말은 지문에 없다.   ③ ○ did not stop and made it = 멈추지 않고 해냈다.");
...
Hs("R1   True / False   ·   1 F · 2 T · 3 F · 4 T · 5 T · 6 T · 7 F · 8 F");
   B("1 F — 문장 5: 필은 빠른 러너가 아니었다.   2 T — 문장 1.   3 F — 문장 13: 오늘날에도 많은(many) 신발이 이 디자인을 쓴다.   4 T — 문장 7.   5 T — 문장 4.   6 T — 문장 12.   7 F — 문장 11: 처음에는 잘되지 않았다.   8 F — 문장 3: 큰 변화가 아니라 작은(small) 변화를 주었다.  거짓 문장은 모두 본문에서 딱 한 요소(big, very fast, from the start, no)를 비튼 것이다 — 그 한 단어를 찾는 것이 정독이다.", true);
Hs("R2   사건 순서   ·   (c) → (b) → (a) → (d)");

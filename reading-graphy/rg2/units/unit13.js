...
Hs("R1   True / False   ·   1 F · 2 F · 3 F · 4 T · 5 F · 6 T · 7 T · 8 T");
   B("1 F — 문장 2: 무서워하는 게 아니라 무서워하지 않는다(aren’t afraid).   2 F — 문장 8: 적(enemies)이 아니라 친구(friends)로 여긴다.   3 F — 문장 5: 차가워지는 게 아니라 따뜻해지고(warmer) 있다.   4 T — 문장 1.   5 F — 문장 12: 더 적은 게 아니라 더 많은(more) 새끼를 가졌다.   6 T — 문장 7.   7 T — 문장 13.  거짓 문장은 모두 본문에서 딱 한 요소(aren’t, warmer, friends, more)를 비튼 것이다 — 그 한 단어를 찾는 것이 정독이다.   8 T — 문장 3.", true);
Hs("R2   사건 순서   ·   (b) → (c) → (d) → (a)");

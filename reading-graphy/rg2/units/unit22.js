...
B("문장 7 collect leftover food   ① ✕ [반대] 남은 음식을 내다 버린다 — 정반대.   ② ✕ [무관] 신선한 음식을 판다는 말은 지문에 없다.   ③ ○ gather = 남은 음식을 한데 모은다.");
B("문장 9 without our amazing volunteers   ① ✕ [무관] 기계의 도움이라는 말은 지문에 없다.   ② ✕ [반대] 자원봉사자가 너무 많아서 — 정반대.   ③ ○ 자원봉사자가 없다면 = 그들이 없으면.");
B("문장 12 people in need   ① ✕ [반대] 모든 것을 다 가진 사람들 — 정반대.   ② ✕ [무관] 사무실에서 일하는 사람들이라는 말은 지문에 없다.   ③ ○ people who need help = 도움이 필요한 사람들.");

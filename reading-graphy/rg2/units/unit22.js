...
["① How to Cook Leftover Food at Home",
 ...
 "④ Join Us and Rescue Food for Hungry People",
...
pairGrid(
  { sn: 5, main: "prevent food waste",
    opts: ["① throw away more food", "② grow food on a farm", "③ stop food from being wasted"] },
  { sn: 7, main: "collect leftover food",
    opts: ["① throw out food that is left over", "② gather food that is left over", "③ sell fresh food at a store"] });
...
pairGrid(
  ...
  { sn: 12, main: "people in need",
    opts: ["① people who have everything", "② people who need help", "③ people who work at the office"] });
...
[["문장 2", [t("Are you interested in ", { size: 19 }), t("( helping  /  help )", { size: 19, bold: true, color: NAVY }), t(" other people?", { size: 19 })], "전치사 in 뒤에는 동사원형이 아니라 -ing!"],
 ...
 ["문장 9", [t("Without our volunteers, we ", { size: 19 }), t("( doesn’t  /  can’t )", { size: 19, bold: true, color: NAVY }), t(" do this work.", { size: 19 })], "'~할 수 없다'는 can’t + 동사원형!"],
...
B("문장 5 prevent food waste   ① ✕ [반대] 음식을 더 버린다 — 정반대.   ② ✕ [무관] 농장에서 음식을 기른다는 말은 지문에 없다.   ③ ○ 음식이 버려지지 않도록 막는다.");
B("문장 7 collect leftover food   ① ✕ [반대] 남은 음식을 내다 버린다 — 정반대.   ② ○ gather = 남은 음식을 한데 모은다.   ③ ✕ [무관] 신선한 음식을 판다는 말은 지문에 없다.");
B("문장 9 without our amazing volunteers   ① ✕ [무관] 기계의 도움이라는 말은 지문에 없다.   ② ✕ [반대] 자원봉사자가 너무 많아서 — 정반대.   ③ ○ 자원봉사자가 없다면 = 그들이 없으면.");
B("문장 12 people in need   ① ✕ [반대] 모든 것을 다 가진 사람들 — 정반대.   ② ○ people who need help = 도움이 필요한 사람들.   ③ ✕ [무관] 사무실에서 일하는 사람들이라는 말은 지문에 없다.");
...
Hs("R1   True / False   ·   1 F · 2 T · 3 T · 4 F · 5 F · 6 T · 7 T · 8 F");
   B("1 F — 문장 3: 겨울 방학이 아니라 여름 방학(summer vacation)이다.   2 T — 문장 10.   3 T — 문장 6.   4 F — 문장 8: 파는(sell) 것이 아니라 준다(give).   5 F — 문장 12: 도울 수 없다가 아니라 도울 수 있게 된다.   6 T — 문장 7.   7 T — 문장 5.   8 F — 문장 9: 자원봉사자 없이는 이 일을 할 수 없다.  거짓 문장은 모두 본문에서 딱 한 요소(sell, without, winter, not)를 비튼 것이다 — 그 한 단어를 찾는 것이 정독이다.", true);
Hs("R2   사건 순서   ·   (b) → (c) → (a) → (d)");

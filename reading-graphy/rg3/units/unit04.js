...
Hs("R1   True / False   ·   1 T · 2 F · 3 F · 4 T · 5 F · 6 T · 7 T · 8 F");
   B("1 T — 문장 11.   2 F — 문장 7: 너무 더운 게 아니라 너무 춥다(too cold).   3 F — 문장 13: 많이 물리는 게 아니라 전혀 물리지 않는다.  거짓 문장은 모두 딱 한 요소만 비튼 것이다.   4 T — 문장 8.   5 F — 문장 4: 725명이 아니라 약 725,000명이다.   6 T — 문장 5.   7 T — 문장 3.   8 F — 문장 10: 여름이 아니라 겨울(winter)에 얼음 아래 숨는다.", true);
Hs("R2   설명 순서   ·   (d) → (a) → (b) → (c)");

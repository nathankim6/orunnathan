...
B("문장 1 Don’t miss out on   ① ○ 놓치지 말라는 뜻.   ② ✕ [반대] 완전히 잊으라는 말 — 정반대.   ③ ✕ [무관] 돈을 많이 내라는 말은 지문에 없다.");
B("문장 4 only lasts for a few minutes   ① ✕ [반대] 하루 종일 계속된다 — 정반대.   ② ✕ [무관] 매달 한 번이라는 말은 지문에 없다.   ③ ○ 아주 짧게 이어진다.");

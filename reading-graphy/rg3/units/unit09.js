...
["① the clothes we wear",
 ...
 "⑤ the little fibers from clothes"].forEach(c => K.push(ch(c)));
K.push(spF(1, 140, 0.13));
...
Hs("R1   True / False   ·   1 F · 2 F · 3 T · 4 T · 5 F · 6 T · 7 T · 8 F");
   B("1 F — 문장 11: 더 높은(higher) 온도가 아니라 더 낮은(lower) 온도다.   2 F — 문장 13: 환경을 해치는 것이 아니라 돕는다.   3 T — 문장 5.   4 T — 문장 2.   5 F — 문장 4: 55%가 아니라 35%다.   6 T — 문장 1.   7 T — 문장 10.   8 F — 문장 6: 숨쉬기를 돕는 것이 아니라 힘들게 한다.  거짓 문장은 모두 한 요소(55%, help, higher, harm)만 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (c) → (d) → (a) → (b)");

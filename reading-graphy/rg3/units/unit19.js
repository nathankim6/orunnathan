...
pairGrid(
  { sn: 9, main: "after retiring from work",
    opts: ["① after he moved to Africa", "② after he stopped working", "③ after he started working"] },
  { sn: 11, main: "make the world a safer place",
    opts: ["① make the world less dangerous", "② make the world more dangerous", "③ make the world much bigger"] });
...
[["문장 1", [t("Magawa ", { size: 19 }), t("( were  /  was )", { size: 19, bold: true, color: NAVY }), t(" a very special rat.", { size: 19 })], "주어 Magawa는 단수예요. 시제는 과거!"],
 ...
 ["문장 8", [t("", { size: 19 }), t("( Thank  /  To thank )", { size: 19, bold: true, color: NAVY }), t(" him for this, he was given a gold medal.", { size: 19 })], "'~하기 위해'는 to+동사원형!"],
...
B("문장 1 a very special rat   ① ○ 다른 쥐들과 같지 않은 쥐.   ② ✕ [반대] 아주 흔한 쥐 — 정반대.   ③ ✕ [무관] 동물원에 산다는 말은 지문에 없다.");
B("문장 2 his great sense of smell   ① ○ 아주 좋은 코 = 뛰어난 후각.   ② ✕ [반대] 아주 나쁜 코 — 정반대.   ③ ✕ [무관] 목소리 이야기는 지문에 없다.");
B("문장 9 after retiring from work   ① ✕ [무관] 아프리카로 옮겼다는 말은 지문에 없다.   ② ○ 일을 그만둔 뒤.   ③ ✕ [반대] 일을 시작한 뒤 — 정반대.");
B("문장 11 make the world a safer place   ① ○ 덜 위험하게 만들다.   ② ✕ [반대] 더 위험하게 만든다 — 정반대.   ③ ✕ [무관] 세상을 더 크게 만든다는 말은 지문에 없다.");
...
Hs("R1   True / False   ·   1 T · 2 F · 3 T · 4 F · 5 T · 6 T · 7 F · 8 F");
   B("1 T — 문장 1.   2 F — 문장 2: 캄보디아가 아니라 탄자니아에서 태어났다.   3 T — 문장 8.   4 F — 문장 9: 12살이 아니라 8살에 세상을 떠났다.   5 T — 문장 5.   6 T — 문장 2.   7 F — 문장 10: 몇 안 되는 목숨이 아니라 아주 많은 목숨(so many lives)을 구했다.   8 F — 문장 7: 20개 미만이 아니라 100개가 넘는다.  거짓 문장은 모두 딱 한 요소(Cambodia, fewer than 20, 12, only a few)만 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (b) → (c) → (a) → (d)");

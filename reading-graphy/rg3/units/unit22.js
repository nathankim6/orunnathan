...
B("문장 7 lighter than the old ones   ① ○ not as heavy as = 옛것만큼 무겁지 않다 = 더 가볍다.   ② ✕ [반대] 더 무겁다 — 정반대.   ③ ✕ [무관] 가격 이야기는 지문에 없다.");
B("문장 11 reflect heat   ① ○ send the heat back = 열을 되돌려 보내다.   ② ✕ [반대] 열을 모두 흡수한다 — 정반대.   ③ ✕ [무관] 소리 이야기는 지문에 없다.");
B("문장 12 allow more people to visit the Moon   ① ✕ [반대] 가지 못하게 막는다 — 정반대.   ② ○ let more people go = 더 많은 사람이 가게 해 주다.   ③ ✕ [무관] 학교 수업 이야기는 지문에 없다.");

...
Hs("R1   True / False   ·   1 F · 2 T · 3 T · 4 F · 5 F · 6 F · 7 T · 8 T");
   B("1 F — 문장 11: 말을 쓰고가 아니라 말을 쓰지 않고(without) 알아듣는다.   2 T — 문장 7.   3 T — 문장 5.   4 F — 문장 8: 같은 톤이 아니라 서로 다른 톤을 쓴다.   5 F — 문장 5: 자음용 휘파람은 열 개가 아니라 네 개다.   6 F — 문장 2: 더 짧게가 아니라 훨씬 멀리(much farther) 간다.   7 T — 문장 1.   8 T — 문장 3.  거짓 문장은 모두 딱 한 요소(shorter, ten, the same tone, with)만 비튼 것이다.", true);
Hs("R2   내용 전개 순서   ·   (a) → (d) → (b) → (c)");

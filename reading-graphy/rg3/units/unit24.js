...
Hs("R1   True / False   ·   1 T · 2 F · 3 F · 4 F · 5 T · 6 T · 7 F · 8 T");
   B("1 T — 문장 4.   2 F — 문장 10–11: 오늘도 만드는 것이 아니라 그 틀은 역사의 일부가 되었다.  거짓 문장은 모두 딱 한 요소(wooden, easy, late 19th century, still)만 비튼 것이다.   3 F — 문장 7: 19세기 말이 아니라 20세기 초에 나왔다.   4 F — 문장 2: 나무 틀이 아니라 금속(metal) 틀이다.   5 T — 문장 9.   6 T — 문장 1.   7 F — 문장 5: 쉬웠던 것이 아니라 쉽지 않았다.   8 T — 문장 6.", true);
Hs("R2   사건 순서   ·   (a) → (b) → (c) → (d)");

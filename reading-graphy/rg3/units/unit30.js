...
Hs("R1   True / False   ·   1 F · 2 T · 3 F · 4 F · 5 T · 6 T · 7 T · 8 F");
   B("1 F — 문장 4: 25% 더 싼 게 아니라 더 비싸다(more).   2 T — 문장 1.   3 F — 문장 11: 중요하지 않다가 아니라 중요하다(important)고 말한다.  거짓 문장은 모두 딱 한 요소(water, less, increasing, not)만 비튼 것이다.   4 F — 문장 7: 증발을 늘려서가 아니라 줄여서(reducing) 물을 아낀다.   5 T — 문장 6.   6 T — 문장 3.   7 T — 문장 10.   8 F — 문장 2: 물 위가 아니라 대부분 땅(land) 위에 있다.", true);
Hs("R2   사건 순서   ·   (a) → (c) → (d) → (b)");

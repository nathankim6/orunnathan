...
B("문장 3 figure out the mystery   ① ✕ [반대] 질문을 잊다 — 정반대.   ② ○ understand the puzzle = 수수께끼를 이해하다.   ③ ✕ [무관] 옛 건물을 판다는 말은 지문에 없다.");
B("문장 9 act like glue   ① ✕ [반대] 부수어 떼어 놓는다 — 정반대.   ② ✕ [무관] 햇빛에 색이 변한다는 말은 지문에 없다.   ③ ○ stick things together = 붙여 준다.");

...
Hs("R1   True / False   ·   1 F · 2 F · 3 T · 4 T · 5 F · 6 T · 7 T · 8 F");
   B("1 F — 문장 10: 세계유산이 아니라 '무형문화유산(Intangible Cultural Heritage)' 목록이다.  거짓 문장은 모두 본문에서 딱 한 요소(million, 40, easy, World Heritage)를 비튼 것이다 — 그 한 곳을 찾는 것이 정독이다.   2 F — 문장 6: 40개가 아니라 400개다.   3 T — 문장 7.   4 T — 문장 9.   5 F — 문장 8: 쉬웠던(easy) 것이 아니라 어려웠다(hard).   6 T — 문장 1.   7 T — 문장 5.   8 F — 문장 3: 600만(million)이 아니라 60억(billion)이다.", true);
Hs("R2   사건 순서   ·   (d) → (b) → (c) → (a)");

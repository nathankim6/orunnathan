...
pairGrid(
  { sn: 1, main: "help plants produce fruits and seeds",
    opts: ["① stop plants from making seeds", "② plant new trees in a forest", "③ make plants able to grow fruits"] },
  { sn: 3, main: "are suffering from a bacterial disease",
    opts: ["① are getting healthier every year", "② are getting sick because of a disease", "③ are moving to a new country"] });
...
B("문장 1 help plants produce fruits and seeds   ① ✕ [반대] 씨를 못 맺게 막는다 — 정반대.   ② ✕ [무관] 숲에 나무를 심는다는 말은 지문에 없다.   ③ ○ 식물이 열매를 맺을 수 있게 해 준다.");
B("문장 3 are suffering from a bacterial disease   ① ✕ [반대] 해마다 더 건강해진다 — 정반대.   ② ○ 병 때문에 아프다.   ③ ✕ [무관] 다른 나라로 옮겨 간다는 말은 지문에 없다.");

...
["① Monet and William Turner",
 ...
 "④ the letters Monet sent to his wife",
 "⑤ the researchers who did the study"].forEach(c => K.push(ch(c)));
K.push(spF(1, 140, 0.13));
...
Hs("R1   True / False   ·   1 F · 2 T · 3 T · 4 F · 5 T · 6 F · 7 F · 8 T");
   B("1 F — 문장 8: 기뻐한 게 아니라 무척 걱정했다(worried).   2 T — 문장 1.   3 T — 문장 8.   4 F — 문장 2: 500점이 아니라 100점 넘게 살펴보았다.   5 T — 문장 9.   6 F — 문장 5: 맞지 않은 게 아니라 맞아떨어졌다(matched).   7 F — 문장 11: 그만둔 게 아니라 작업을 계속했다(continued).   8 T — 문장 3.  거짓 문장은 모두 한 요소만 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (d) → (b) → (a) → (c)");

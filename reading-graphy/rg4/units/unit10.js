...
["① the town of Setenil",
 ...
 "④ the vineyard destroyed by insects",
 "⑤ the word “Bodegas”"].forEach(c => K.push(ch(c)));
K.push(spF(1, 140, 0.13));
...
["① 물건을 팔기 위해 만든 광고",
 ...
 "③ 안부를 전하는 편지",
 "④ 상상으로 지어낸 동화",
 "⑤ 마을을 소개하고 사실을 알려 주는 설명문"].forEach(c => K.push(p([t(c, { size: 19 })], { after: 55, indent: { left: 440, hanging: 190 }, line: 268 })));

...
Hs("R1   True / False   ·   1 T · 2 F · 3 F · 4 F · 5 T · 6 F · 7 T · 8 T");
   B("1 T — 문장 8.   2 F — 문장 5: 호주가 아니라 인도네시아다.   3 F — 문장 2: 새(birds)가 아니라 포유류(mammals)다.   4 F — 문장 10: 흔한(common) 것이 아니라 드문(rare) 일이다.   5 T — 문장 4.   6 F — 문장 7: 80%가 아니라 20%다.   7 T — 문장 1.   8 T — 문장 6.  거짓 문장은 모두 딱 한 요소(birds, Australia, 80%, common)만 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (a) → (c) → (b) → (d)");

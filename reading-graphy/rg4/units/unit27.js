...
Hs("R1   True / False   ·   1 T · 2 F · 3 T · 4 F · 5 F · 6 T · 7 F · 8 T");
   B("1 T — 문장 9.   2 F — 문장 3: 아픈 사람이 아니라 건강한 사람(healthy person)의 대변에서 얻는다.   3 T — 문장 5.   4 F — 문장 6: 드문 게 아니라 일부 암에는 흔하다(common).   5 F — 문장 8: 빨리 나가는 게 아니라 오래 입원한다.   6 T — 문장 1.   7 F — 문장 10: 이미 끝낸 게 아니라 계속 애쓰는 중이다.   8 T — 문장 7.  거짓은 모두 딱 한 요소(sick, rare, quickly, finished)를 비튼 것이다.", true);
Hs("R2   사건 순서   ·   (a) → (b) → (d) → (c)");
